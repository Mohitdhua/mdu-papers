...
export const mockCourses: Course[] = [
  ...
  { id: 2, name: 'B.Tech CSE', full_name: 'Bachelor of Technology - Computer Science', degree_type: 'UG', slug: 'btech-cse', total_semesters: 8, icon_emoji: '⚙️', is_popular: true },
  { id: 3, name: 'BSc (CS)', full_name: 'Bachelor of Science - Computer Science', degree_type: 'UG', slug: 'bsc-cs', total_semesters: 6, icon_emoji: '🔬', is_popular: true },
  { id: 4, name: 'BCom', full_name: 'Bachelor of Commerce', degree_type: 'UG', slug: 'bcom', total_semesters: 6, icon_emoji: '📊', is_popular: true },
  { id: 5, name: 'BA (English)', full_name: 'Bachelor of Arts - English', degree_type: 'UG', slug: 'ba-english', total_semesters: 6, icon_emoji: '📖', is_popular: false },
  { id: 6, name: 'BBA', full_name: 'Bachelor of Business Administration', degree_type: 'UG', slug: 'bba', total_semesters: 6, icon_emoji: '💼', is_popular: true },
  { id: 7, name: 'MBA', full_name: 'Master of Business Administration', degree_type: 'PG', slug: 'mba', total_semesters: 4, icon_emoji: '🎯', is_popular: true },
  { id: 8, name: 'MCA', full_name: 'Master of Computer Applications', degree_type: 'PG', slug: 'mca', total_semesters: 4, icon_emoji: '🖥️', is_popular: true },
  { id: 9, name: 'MSc (CS)', full_name: 'Master of Science - Computer Science', degree_type: 'PG', slug: 'msc-cs', total_semesters: 4, icon_emoji: '🧪', is_popular: false },
  { id: 10, name: 'MCom', full_name: 'Master of Commerce', degree_type: 'PG', slug: 'mcom', total_semesters: 4, icon_emoji: '📈', is_popular: false },
  { id: 11, name: 'B.Tech ECE', full_name: 'Bachelor of Technology - Electronics', degree_type: 'UG', slug: 'btech-ece', total_semesters: 8, icon_emoji: '📡', is_popular: false },
  { id: 12, name: 'B.Tech ME', full_name: 'Bachelor of Technology - Mechanical', degree_type: 'UG', slug: 'btech-me', total_semesters: 8, icon_emoji: '🔧', is_popular: false },
  { id: 13, name: 'BSc (Physics)', full_name: 'Bachelor of Science - Physics', degree_type: 'UG', slug: 'bsc-physics', total_semesters: 6, icon_emoji: '⚛️', is_popular: false },
  { id: 14, name: 'BSc (Math)', full_name: 'Bachelor of Science - Mathematics', degree_type: 'UG', slug: 'bsc-math', total_semesters: 6, icon_emoji: '🔢', is_popular: false },
  { id: 15, name: 'BA (Hindi)', full_name: 'Bachelor of Arts - Hindi', degree_type: 'UG', slug: 'ba-hindi', total_semesters: 6, icon_emoji: '📝', is_popular: false },
];
