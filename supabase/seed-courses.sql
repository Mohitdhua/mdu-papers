...
('B.Arch', 'Bachelor of Architecture', 'UG', 'barch', 10, '🏛️', false),
('BSc', 'Bachelor of Science', 'UG', 'bsc', 6, '🔬', false),
-- ---------- Others (Law, Education & Research) ----------
('BA LLB', 'Bachelor of Arts & Bachelor of Laws (Integrated)', 'Others', 'ballb', 10, '⚖️', false),
('BBA LLB', 'Bachelor of Business Administration & Bachelor of Laws (Integrated)', 'Others', 'bballb', 10, '⚖️', false),
('LLB', 'Bachelor of Laws', 'Others', 'llb', 6, '📋', false),
('B.Ed', 'Bachelor of Education', 'Others', 'b-ed', 4, '🎓', false),
('B.P.Ed', 'Bachelor of Physical Education', 'Others', 'bped', 4, '🏅', false),
('Diploma', 'Polytechnic Diploma in Engineering', 'Others', 'diploma', 6, '📜', false),
('M.Phil', 'Master of Philosophy', 'Others', 'mphil', 4, '🖋️', false),
('Ph.D', 'Doctor of Philosophy', 'Others', 'phd', 6, '🎓', false),
-- ---------- Postgraduate (PG) ----------
...
('M.Ed', 'Master of Education', 'Others', 'med', 4, '📔', false),
('M.P.Ed', 'Master of Physical Education', 'Others', 'mped', 4, '🏆', false),
